...
def analysis(csv_file):
    ...
    time = results[0]
    DoseRate = results[1]
    #Plots the Dose rate that you should've seen in the lab
    ...
    peaklocs, a = find_peaks(der,height = 875,distance = 5)
#    plt.subplot(1,2,1)
#    
#    
    ...
    tube_current = np.array([1,2,3,4,5,10,15,20,25])
    #plt.subplot(1,2,2)
